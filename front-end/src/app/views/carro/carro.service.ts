...
export class CarroService {
  ...
  async adicionarEditarCarro({id,empresa,modelo,placa,ano,marca}) {
    try {
      this.carroInfo = new Carro(
        ...
        await this.adicionarEditarCarroFunction(this.carroInfo).subscribe((data) => {
  ...
  async update({id,empresa,modelo,placa,ano,marca}){
    try {
      this.carroInfo = new Carro(
        ...
        await this.updateCarroFunction(id,this.carroInfo).subscribe((data) => {
  ...
  getCarros():Observable<Carro>{
    return this.http.get<Carro>(this.urlCarros, httpOptions);
  }
  ...
  updateCarroFunction(id:string, info:Carro): Observable<Carro>{
    return this.http.put<Carro>(this.urlCarros+'/'+id, info, httpOptions);
  }
  adicionarEditarCarroFunction(info: Carro): Observable<string> {
    return this.http.post<string>(this.urlCarros+'/add', info, httpOptions);
  }
